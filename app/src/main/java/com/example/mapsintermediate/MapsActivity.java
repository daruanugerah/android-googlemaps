package com.example.mapsintermediate;
...
import com.example.mapsintermediate.helper.DirectionMapsV2;
import com.example.mapsintermediate.helper.GPStrack;
import com.example.mapsintermediate.model.ResponseRoute;
import com.example.mapsintermediate.network.ConfigRetrofit;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private final int REQ_AWAL = 10;
    private final int REQ_AKHIR = 11;
            ...
            googleApiClient = new GoogleApiClient.Builder(this)
                    ...
                    .addOnConnectionFailedListener(new GoogleApiClient.OnConnectionFailedListener() {
                        ...
                        public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                            Log.d("LocationError", "Location Error:" + connectionResult.getErrorMessage());
                        }
                    }).build();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQ_AWAL) {
            if (resultCode == RESULT_OK) {
                Place place = Autocomplete.getPlaceFromIntent(data);

                mMap.clear(); //ngehapus marker my location
